...
botonDiv = document.getElementById("bd")
botonDiv.addEventListener("click",operador)

botonMul = document.getElementById("bm")
botonMul.addEventListener("click",operador)

botonResultado = document.getElementById("bres")
botonResultado.addEventListener("click",calcular)

botonBp = document.getElementById("bp")
botonBp.addEventListener("click",escribir)
